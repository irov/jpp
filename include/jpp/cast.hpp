...
namespace jpp
{
    ...
    struct cast_object_internal
    {
        ...
        void operator()( json_t * _j, jpp_int8_t * _value ) const;
        void operator()( json_t * _j, jpp_uint8_t * _value ) const;
        void operator()( json_t * _j, jpp_int16_t * _value ) const;
        void operator()( json_t * _j, jpp_uint16_t * _value ) const;
        void operator()( json_t * _j, jpp_int32_t * _value ) const;
        void operator()( json_t * _j, jpp_uint32_t * _value ) const;
        void operator()( json_t * _j, jpp_int64_t * _value ) const;
        ...
        json_t * operator()( jpp_int8_t _value ) const;
        json_t * operator()( jpp_uint8_t _value ) const;
        json_t * operator()( jpp_int16_t _value ) const;
        json_t * operator()( jpp_uint16_t _value ) const;
        json_t * operator()( jpp_int32_t _value ) const;
        json_t * operator()( jpp_uint32_t _value ) const;
        json_t * operator()( jpp_int64_t _value ) const;
